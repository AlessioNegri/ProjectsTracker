...
{
    /// <summary> Logica di interazione per DialogRELEASE.xaml </summary>
    public partial class DialogRELEASE : Window, INotifyPropertyChanged
    {
        #region READONLY
        ...
        public DialogRELEASE(Window? parent = null)
        {
            Owner = parent;
        ...
        private bool InsertRELEASE()
        {
            ...
            TablesManager.Instance.InsertRELEASE(ProjectId, row);

            return true;
        }

        /// <summary> Edits an existing RELEASE </summary>
        /// <returns> Success of the operations </returns>
        private bool EditRELEASE()
        {
            var row = new ROW_TABLE();
            ...
            TablesManager.Instance.UpdateRELEASE(ProjectId, row);
